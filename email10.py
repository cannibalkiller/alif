...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttp://line.me/ti/p/~reza.p.i.p\nhttp://line.me/ti/p/ryansakra_m1")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "[☯️ CANNIBAL™️]1")
                                ki.sendMessage(msg.to, "[☯️ CANNIBAL™️]2")
                                kk.sendMessage(msg.to, "[☯️ CANNIBAL™️]3")
                                kc.sendMessage(msg.to, "[☯️ CANNIBAL™️]4")
                                kb.sendMessage(msg.to, "[☯️ CANNIBAL™️]5")
                                kd.sendMessage(msg.to, "[☯️ CANNIBAL™️]6")
                                ke.sendMessage(msg.to, "[☯️ CANNIBAL™️]7")
                                kf.sendMessage(msg.to, "[☯️ CANNIBAL™️]8")
                                kj.sendMessage(msg.to, "[☯️ CANNIBAL™️]9")
                                sw.sendMessage(msg.to, "[☯️ CANNIBAL™️]10")
                                cl.sendMessage(msg.to, "╔═══╗\n║╔═╗║\n║║─║╠╗╔╦══╦═╗\n║╚═╝║╚╝║╔╗║╔╗╗\n║╔═╗║║║║╔╗║║║║\n╚╝─╚╩╩╩╩╝╚╩╝╚╝")
...
#===========Hiburan============#
                        ...
                        elif cmd == "dkbot" or cmd == "cannibal":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
